  ...
  return (
    <div className="options">
      <div className='options-buttons'>
        <a className='options-button' onClick={() => navigate('/public/')}>Planificación Personalizada</a>
        <a className='options-button' onClick={() => navigate('/public/')}>Planificación Estandarizada</a>
